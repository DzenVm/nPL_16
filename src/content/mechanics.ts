...
const raw: Mechanic[] = [
  {
    ...
    summary: "Podmuchy jako przeszkoda i jako narzędzie — trzeba je czytać, nie tylko przetrwać.",
    detail:
      "Na wskaźniku podmuchu widać siłę i kierunek wiatru z wyprzedzeniem kilku sekund. Zbyt wczesny krok kończy się zepchnięciem z półki skalnej, zbyt późny — brakiem rozpędu, by przesadzić szczelinę. Z czasem gracz uczy się wykorzystywać silniejsze porywy do skoków, na które normalnie nie byłoby miejsca.",
  },
  {
    slug: "przyplywy",
    title: "Rytm przypływów",
    summary: "Część mapy istnieje tylko przez kilka minut na dobę — reszta czasu spędza pod wodą.",
    detail:
  ...
  },
  {
    ...
    summary: "Mapa nie jest dana z góry — gracz rysuje ją sam, w miarę odkrywania kolejnych przejść.",
    detail:
