...
const raw: Chapter[] = [
  {
    ...
    detail:
      "To tutaj zaczyna się każda wyprawa. Klify są strome, ścieżki wąskie, a wiatr zmienia kierunek co kilkanaście sekund — i to on decyduje, które przejście jest bezpieczne, a które kończy się upadkiem w dół, do rozbryzgującej się o skały piany. Gracz uczy się odczytywać wskaźnik podmuchu, wyczuwać moment ciszy między porywami i wykorzystywać silniejsze uderzenia wiatru do przesadzenia przez szczeliny zbyt szerokie na zwykły krok. Rozdział jest krótki, ale celowo bezlitosny w prostocie: to on tłumaczy resztę gry.",
    status: "demo",
  },
  {
  ...
  },
  {
    ...
    detail:
      "Im wyżej po spiralnych schodach, tym więcej zapisków, map i luźnych kartek z dziennika ostatniego latarnika. Gracz składa je w spójną całość, próbując zrozumieć, dlaczego latarnia wciąż działa i co dokładnie nadawała ostatniej nocy przed zniknięciem załogi. Mechanika dziennika ekspedycji, wprowadzana subtelnie od pierwszego rozdziału, tutaj staje się centralnym elementem rozgrywki — to notatki gracza, a nie instrukcje gry, prowadzą do finałowego pomieszczenia latarni.",
    status: "planowany",
  },
  {
